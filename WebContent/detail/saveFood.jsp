            ...
            <div class="ItemBlock">
				<div class="ItemBlock2">
                    ...
                    <tr>
							<td width="80px">菜系</td>
							<td>
                        	<!-- 调用MyFoodType里的getAllFoodtype()方法 -->
                        	<!-- 用jsp:useBean实例化MyFoodType class表示实例化对象  默认放在page作用域-->
							<jsp:useBean id="myfoodType" class="cn.et.model.MyFoodType"></jsp:useBean>
                            <select name="typeId" style="width:80px">
	                            <c:forEach var="tmp" items="${pageScope.myfoodType.allFoodtype}">
	                            	<!-- 传的值是id 显示的是名字 -->
			   						<option value="${pageScope.tmp.TYPEID }" >
			   							${pageScope.tmp.TYPENAME }
			   						</option>
			   					</c:forEach>
                            </select>
